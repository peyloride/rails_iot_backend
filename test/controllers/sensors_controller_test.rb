...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { address: @sensor.address, name: @sensor.name, type: @sensor.type } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { address: @sensor.address, name: @sensor.name, type: @sensor.type } }
